...
#define HI_GAUGEMNG_ETHREAD           HI_APPCOMM_ERR_ID(HI_APP_MOD_GAUGEMNG,HI_ERRNO_CUSTOM_BOTTOM+1)            /**<thread creat or join error*/
 /** CONFIG_ADC_ON define */
#define GAUGEMNG_MEASURED_DEVIATION 20 //adc measurement error parameter
#define GAUGEMNG_FIRST_DEVIATION    4 //Kalman deviation of initial value
...
/**
* @brief   use kalman to correction level
* @param[in] u32Ave: system get adc 
* @param[out] ps32Level: kalman level
* @return 0 success,non-zero error code.
* @exception    None
* @date      2019/12/27
*/
HI_S32 HI_GAUGEMNG_GetKalmanLevel(HI_U32* pu32Level, HI_U32 u32Ave);
