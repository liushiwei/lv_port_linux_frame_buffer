...
HI_VOID HI_LOG_Print(HI_LOG_LEVEL_E enLevel, const HI_CHAR *pszModule, const HI_CHAR *pszFunc, HI_U32 u32Line,
                     const HI_CHAR *pszFmt, ...) __attribute__((format(printf, 5, 6)));
