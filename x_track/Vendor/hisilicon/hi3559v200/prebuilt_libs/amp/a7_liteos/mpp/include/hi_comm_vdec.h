...
typedef struct hiVDEC_CHN_STATUS_S {
    ...
    HI_U32 u32Width; /* R; the width of the currently decoded stream */
    HI_U32 u32Height; /* R; the height of the currently decoded stream */
} VDEC_CHN_STATUS_S;
...
typedef struct hiVDEC_USER_DATA_ATTR_S {
    HI_BOOL bEnable;
    HI_U32  u32MaxUserDataLen;
