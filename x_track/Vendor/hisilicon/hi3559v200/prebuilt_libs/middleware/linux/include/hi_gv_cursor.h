...
typedef struct {
    ...
    /*  The max size of cursor bitmap is 64x64, and small size is 16x16 ,    CNcomment:光标图片最大64x64,最小16x16像素 */
...
/*
* brief Set the aceleration attributes of cursor. CNcomment:鼠标加速参数控制CNend
* attention \n
* The threshold is should generate and equal 3, default is 4, and the accelation paramater is should generate 0, default
* is 4. CNcomment:加速阀值必须大于等于3，默认值4 ；加速度必须大于0，默认值5CNend \param[in] threshold of
* cursor.CNcomment:鼠标加速阀值CNend \param[in] acceleration Acceleration of cursor.CNcomment:鼠标加速倍数CNend
* retval ::HI_SUCCESS
* retval ::HI_FAILURE
*/
HI_S32 HI_GV_CURSOR_SetAccelAttr(HI_U16 threshold, HI_U16 acceleration);
...
* see
*/
HI_S32 HI_GV_CURSOR_Init(HI_VOID);
...
* retval ::HI_FAILURE
*/
HI_S32 HI_GV_CURSOR_SetScreenPos(HIGV_CORD x, HIGV_CORD y);
...
* retval ::HI_FAILURE
*/
HI_S32 HI_GV_CURSOR_GetScreenPos(HIGV_CORD *x, HIGV_CORD *y);
...
* retval ::HI_SUCCESS
*/
HI_S32 HI_GV_CURSOR_SetCursorRegion(HI_S32 x_pos, HI_S32 y_pos, HI_S32 width, HI_S32 height);
...
* retval ::HI_FAILURE
*/
HI_S32 HI_GV_CURSOR_SetDisplayScreen(HI_U32 devID, HI_U32 w, HI_U32 h);
...
* retval ::HI_FAILURE
*/
HI_S32 HI_GV_CURSOR_AttchLayer(HIGO_LAYER_E layer);
...
* retval ::HI_FAILURE
*/
HI_S32 HI_GV_CURSOR_DettchLayer(HIGO_LAYER_E layer);
