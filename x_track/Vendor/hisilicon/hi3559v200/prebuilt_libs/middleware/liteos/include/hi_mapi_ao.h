 ...
 * @exception    None
*/
HI_S32 HI_MAPI_AO_EnableVqe(HI_HANDLE aoHdl, HI_HANDLE aoChnHdl, const HI_MAPI_AO_VqeAttr *aoVqeAttr);

/**
 * @brief    disable ao vqe func
 * @param[in] AoHdl
 * @param[in] AoChnHdl
 * @return 0 success,non-zero error code.
 * @exception    None
*/
HI_S32 HI_MAPI_AO_DisableVqe(HI_HANDLE aoHdl, HI_HANDLE aoChnHdl);
