...
COMPILE_CPP    = $(CXX) $(PDT_DEFS) -std=c++0x $(PDT_FLAGS) -c "$<" -o "$@" $(PDT_INCLUDE_PATH)
COMPILEDEP_CPP = $(CXX) -MM "$<"  $(PDT_DEFS) -std=c++0x $(PDT_FLAGS) $(PDT_INCLUDE_PATH)
COMPILE_C    = $(CC) $(PDT_DEFS) $(PDT_FLAGS) -c "$<" -o "$@" $(PDT_INCLUDE_PATH)
COMPILEDEP_C = $(CC) -MM "$<"  $(PDT_DEFS) $(PDT_FLAGS) $(PDT_INCLUDE_PATH)
LINK       = $(CXX) $(PDT_DEFS) $(PDT_FLAGS)
ARFLAGS = sq
