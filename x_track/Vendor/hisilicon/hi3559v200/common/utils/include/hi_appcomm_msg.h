...
typedef HI_S32 (*HI_MSG_PROC_CALLBACK_FN_PTR)(HI_S32 s32MsgID, const HI_VOID *pvRequest, HI_U32 u32ReqLen,
 ...
 * @param[in] u32MsgLen:msg data length.
 ...
 * @param[in] u32ReqLen:request data length.
 * @param[in] pstPrivData:private data.
 * @param[out] pvResponse:response data.
 * @param[in] u32RespLen:response data length.
 * @return 0 success,non-zero error code.
 * @exception    None
 * @author    HiMobileCam Reference Develop Team
 * @date      2017/12/22
 */
HI_S32 HI_MSG_SendSync(HI_S32 s32MsgID, const HI_VOID *pvRequest, HI_U32 u32ReqLen,
                       HI_MSG_PRIV_DATA_S *pstPrivData, HI_VOID *pvResponse, HI_U32 u32RespLen);
