...
typedef struct {
    HI_BOOL enable;          /* low delay enable. */
    HI_U32 lineCnt;          /* range: [16, 16384]; Low delay shoreline. */
} HI_MAPI_VPROC_LowDelayInfo;
...
typedef struct hiMAPI_VPORT_ATTR_S {
    ...
    HI_MAPI_VPROC_LowDelayInfo lowDelayInfo;
...
typedef struct hiMAPI_VPROC_CROP_ATTR_S
{
    HI_U32 u32MaxW;
    HI_U32 u32MaxH;
    HI_U32 zoom;
    HI_BOOL bEnable;
} HI_MAPI_VPROC_CROP_ATTR_S;
