/*
  ...
  * Description: support search, delete and add group or obj func
...
#define HI_ERR_DCF_WRAPPER_NULL_PTR \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NULL_PTR)
#define HI_ERR_DCF_WRAPPER_ILLEGAL_PARAM \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_ILLEGAL_PARAM)
#define HI_ERR_DCF_WRAPPER_REINIT HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_REINIT)
#define HI_ERR_DCF_WRAPPER_NOT_INIT \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NOT_INIT)
#define HI_ERR_DCF_WRAPPER_INVALID_INDEX \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_INVALID_INDEX)
#define HI_ERR_DCF_WRAPPER_NOT_ENOUGH_INDEX \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NOT_ENOUGH_INDEX)
#define HI_ERR_DCF_WRAPPER_INSTANCE_NOT_DESTROY \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_INSTANCE_NOT_DESTROY)
#define HI_ERR_DCF_WRAPPER_SCAN_THREAD_CREATE_FAILURE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_SCAN_THREAD_CREATE_FAILURE)
#define HI_ERR_DCF_WRAPPER_LAST_DIR_NOT_SCANDONE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_LAST_DIR_NOT_SCANDONE)
#define HI_ERR_DCF_WRAPPER_FIRST_DIR_NOT_SCANDONE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_FIRST_DIR_NOT_SCANDONE)
#define HI_ERR_DCF_WRAPPER_ALL_DIR_NOT_SCANDONE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_ALL_DIR_NOT_SCANDONE)
#define HI_ERR_DCF_WRAPPER_SCAN_FAILURE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_SCAN_FAILURE)

#define HI_ERR_DCF_WRAPPER_ROOT_ENOTDIR \
    HI_APP_DEF_ERR(HI_APPID_DCF, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_ROOT_ENOTDIR)
#define HI_ERR_DCF_WRAPPER_ROOT_ENOENT \
    HI_APP_DEF_ERR(HI_APPID_DCF, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_ROOT_ENOENT)
#define HI_ERR_DCF_WRAPPER_ROOT_ALREADY_OCCUPIED \
    HI_APP_DEF_ERR(HI_APPID_DCF, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_ROOT_ALREADY_OCCUPIED)
#define HI_ERR_DCF_WRAPPER_IMAGEROOT_ENOTDIR \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_IMAGEROOT_ENOTDIR)
#define HI_ERR_DCF_WRAPPER_IMAGEROOT_ENOENT \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_IMAGEROOT_ENOENT)
#define HI_ERR_DCF_WRAPPER_DIR_ENOTDIR \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_DIR_ENOTDIR)
#define HI_ERR_DCF_WRAPPER_DIR_ENOENT \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_DIR_ENOENT)
#define HI_ERR_DCF_WRAPPER_DIR_NOT_EXIST \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_DIR_NOT_EXIST)

#define HI_ERR_DCF_WRAPPER_MAKE_DIR_FAILURE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_MAKE_DIR_FAILURE)
#define HI_ERR_DCF_WRAPPER_NOT_ENOUGH_DIR \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NOT_ENOUGH_DIR)
#define HI_ERR_DCF_WRAPPER_NOT_ENOUGH_SIZE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NOT_ENOUGH_SIZE)
#define HI_ERR_DCF_WRAPPER_NOT_ENOUGH_MEMORY \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NOT_ENOUGH_MEMORY)
#define HI_ERR_DCF_WRAPPER_SYSTEM_CALL_FAILURE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_SYSTEM_CALL_FAILURE)

#define HI_ERR_DCF_WRAPPER_EMPTY_DB \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_EMPTY_DB)
#define HI_ERR_DCF_WRAPPER_NO_NEXT \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NO_NEXT)
#define HI_ERR_DCF_WRAPPER_NO_PREV \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NO_PREV)
#define HI_ERR_DCF_WRAPPER_EMPTY_GRP \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_EMPTY_GRP)
#define HI_ERR_DCF_WRAPPER_UNKNOW_CUR_GRP \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_UNKNOW_CUR_GRP)
#define HI_ERR_DCF_WRAPPER_UNKNOW_CUR_OBJ \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_UNKNOW_CUR_OBJ)
#define HI_ERR_DCF_WRAPPER_INVALID_OBJ_TYPE_INDEX \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_INVALID_OBJ_TYPE_INDEX)
#define HI_ERR_DCF_WRAPPER_BUSY_OBJ \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_BUSY_OBJ)
#define HI_ERR_DCF_WRAPPER_OBJ_NOT_EXIST \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_OBJ_NOT_EXIST)
#define HI_ERR_DCF_WRAPPER_OBJ_ALREADY_EXIST \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_OBJ_ALREADY_EXIST)

#define HI_ERR_DCF_WRAPPER_INVALID_FILEPATH \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_INVALID_FILEPATH)
#define HI_ERR_DCF_WRAPPER_NOT_MAIN_FILE \
    HI_APP_DEF_ERR(HI_APPID_DCF_WRAPPER, APP_ERR_LEVEL_ERROR, APP_DCF_WRAPPER_ERR_NOT_MAIN_FILE)
...
/**
*  Description  DCF scan event callback, s32ScanErrCode is error code of scan failure,
...
/**
*   Description  destroy a DCF instance.
...
/**
*   Description  get u32Interval th group after current group.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  get u32Interval th group before current group.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @param[in] u32Interval : HI_U32: the interval from current group
*   @param[out] pstGrp : HI_DCF_WRAPPER_GRP_S*: DCF group
*   @retval  on success, 0 is returned. On error, error code returned.
...
/**
*   Description  delete current group. Include notes in database and file entity in storage device.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @retval  on success, 0 is returned. On error, error code returned.
*/
...
/**
*   Description  get total group count.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  get group count of specified object type.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  get first object in current group.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  get last object in current group.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @param[out] pstObj : HI_DCF_WRAPPER_OBJ_S*: DCF object
*   @retval  on success, 0 is returned. On error, error code returned.
*/
...
/**
*   Description  get next object from current object of current group.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @param[out] pstObj : HI_DCF_WRAPPER_OBJ_S*: DCF object
*   @retval  on success, 0 is returned. On error, error code returned.
*/
...
/**
*   Description  get prev object from current object of current group.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @param[out] pstObj : HI_DCF_WRAPPER_OBJ_S*: DCF object
*   @retval  on success, 0 is returned. On error, error code returned.
*/
...
/**
*   Description  get next object list from the given object.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  get prev object list from the given object.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  add object to a DCF instance.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  delete object from a DCF instance. Include notes in database and file entity in storage device.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @param[in] pszMainFile : HI_CHAR*: main file of DCF object, and it identifies a unique object
*   @retval  on success, 0 is returned. On error, error code returned.
*/
...
/**
*   Description  get total object count.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
...
/**
*   Description  get object count of specified object type.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
*   @param[in] u8ObjTypIndex : HI_U8: DCF object type index
*   @param[out] pu32Cnt : HI_U32*: object count
*   @retval  on success, 0 is returned. On error, error code returned.
...
/**
*   Description  get file path list a new object.
*   @param[in] iDCF : HI_DCF_WRAPPER_INDEX: DCF instance index
