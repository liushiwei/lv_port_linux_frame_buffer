...
/**
 * @brief    enable audio quality enhance with record config
 * @param[in] AcapHdl
 * @param[in] AcapChnHdl
 * @return 0 success,non-zero error code.
 * @exception    None
 */
HI_S32 HI_MAPI_ACAP_EnableRecordVqe(HI_HANDLE AcapHdl, HI_HANDLE AcapChnHdl);

/**
 * @brief    enable audio quality enhance with talk config
 * @param[in] AcapHdl
 * @param[in] AcapChnHdl
 * @param[in] AoHdl
 * @return 0 success,non-zero error code.
 * @exception    None
 */
HI_S32 HI_MAPI_ACAP_EnableTalkVqe(HI_HANDLE AcapHdl, HI_HANDLE AcapChnHdl, HI_HANDLE AoHdl);
