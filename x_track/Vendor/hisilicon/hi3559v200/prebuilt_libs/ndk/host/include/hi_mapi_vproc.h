...
/**
 * @brief set vpss crop attr. It must be created first.
 * @param[in] VpssHdl HI_HANDLE : handle of vpss.
 * @param[in] pstCropAttr  : attr of vpss
 * @return 0  successful.
 * @return non 0  fail.
 */
HI_S32 HI_MAPI_VPROC_SetCropAttr(HI_HANDLE VpssHdl, HI_MAPI_VPROC_CROP_ATTR_S* pstCropAttr);

/**
 * @brief get vpss crop attr. It must be created first.
 * @param[in] VpssHdl HI_HANDLE : handle of vpss.
 * @param[out] pstCropAttr  : attr of vpss
 * @return 0  successful.
 * @return non 0  fail.
 */
HI_S32 HI_MAPI_VPROC_GetCropAttr(HI_HANDLE VpssHdl, HI_MAPI_VPROC_CROP_ATTR_S* pstCropAttr);
...
/**
 * @brief send frame data to vpss.
 * @param[in] vpssHdl HI_HANDLE : handle of vpss.
 * @param[in] framedata HI_MAPI_FRAME_DATA_S *: frame data info.
 * @return 0  successful.
 * @return non 0  fail.
 */
HI_S32 HI_MAPI_VPROC_SendFrame(HI_HANDLE vpssHdl, const HI_MAPI_FRAME_DATA_S *framedata);
#ifdef __cplusplus
#if __cplusplus
}
#endif
