...
typedef struct hiVENC_H264_TRANS_S {
    ...
    HI_U8      InterScalingList8X8[HI_VENC_SCALING_LIST_SIZE_64];         /* RW; Range:[1, 255]; A quantization table for 8x8 inter-prediction */
    HI_U8      IntraScalingList8X8[HI_VENC_SCALING_LIST_SIZE_64];         /* RW; Range:[1, 255]; A quantization table for 8x8 intra-prediction */
...
typedef struct hiVENC_H265_TRANS_S {
    ...
    HI_U8   InterScalingList4X4[2][HI_VENC_SCALING_LIST_SIZE_16];       /* RW; Range:[1, 255]; Scaling List for inter 4X4 block. */
    HI_U8   IntraScalingList4X4[2][HI_VENC_SCALING_LIST_SIZE_16];       /* RW; Range:[1, 255]; Scaling List for intra 4X4 block. */

    HI_BOOL bScalingListTu8Valid;             /* RW; Range:[0, 1]; If 1, ScalingList8X8 belows will be encoded. */
    HI_U8   InterScalingList8X8[2][HI_VENC_SCALING_LIST_SIZE_64];       /* RW; Range:[1, 255]; Scaling List for inter 8X8 block. */
    HI_U8   IntraScalingList8X8[2][HI_VENC_SCALING_LIST_SIZE_64];       /* RW; Range:[1, 255]; Scaling List for intra 8X8 block. */

    HI_BOOL bScalingListTu16Valid;            /* RW; Range:[0, 1]; If 1, ScalingList16X16 belows will be encoded. */
    HI_U8   InterScalingList16X16[2][HI_VENC_SCALING_LIST_SIZE_64];     /* RW; Range:[1, 255]; Scaling List for inter 16X16 block. */
    HI_U8   IntraScalingList16X16[2][HI_VENC_SCALING_LIST_SIZE_64];     /* RW; Range:[1, 255]; Scaling List for inter 16X16 block. */

    HI_BOOL bScalingListTu32Valid;            /* RW; Range:[0, 1]; If 1, ScalingList32X32 belows will be encoded. */
    HI_U8   InterScalingList32X32[HI_VENC_SCALING_LIST_SIZE_64];        /* RW; Range:[1, 255]; Scaling List for inter 32X32 block. */
    HI_U8   IntraScalingList32X32[HI_VENC_SCALING_LIST_SIZE_64];        /* RW; Range:[1 ,255]; Scaling List for inter 32X32 block. */
...
typedef struct hiVENC_HIERARCHICAL_QP_S {
    ...
    HI_S32      s32HierarchicalQpDelta[HI_VENC_MAX_HIERARCHY_NUM];      /* RW; Range:[-10, 10]; QP delta of the frames at each layer
                                                relative to the P-frame at layer 0 */
    HI_S32      s32HierarchicalFrameNum[HI_VENC_MAX_HIERARCHY_NUM];     /* RW; Range:[0, 5];    Number of frames at each layer */
