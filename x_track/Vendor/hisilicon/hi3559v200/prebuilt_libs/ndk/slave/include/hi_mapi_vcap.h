...
/**
 * @brief Set Motion Sensor WakeUp.
 * @param[in] pstMotionAttr HI_MAPI_MOTIONSENSOR_INFO_S:info of Motionsensor.
 * @return 0  init Motion Sensor success.
 * @return Non 0  init Motion Sensor fail.
 */
HI_S32 HI_MAPI_VCAP_SetMotionSensorWakeUp(HI_MAPI_MOTIONSENSOR_INFO_S *pstMotionAttr);

/**
 * @brief get Motion Sensor Collision status.
 * @param[out] Collision status
 * @return 0  get Motion Sensor Collision success.
 * @return Non 0  get Motion Sensor Collision fail.
 */
HI_S32 HI_MAPI_VCAP_MotionSensorCollisionCheck(HI_BOOL *bCollision);
