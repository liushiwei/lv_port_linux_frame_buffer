...
typedef enum hiGPSMNG_GPS_MODE
{
    HI_GPS_MODE_OFF = 0,
    HI_GPS_MODE_DOUBLE,
    HI_GPS_MODE_BD,
    HI_GPS_MODE_GPS,
    HI_GPS_MODE_RE_FULL_COLD_DOUBLE,
    HI_GPS_MODE_RE_FULL_COLD_BD,
    HI_GPS_MODE_RE_FULL_COLD_GPS,
    HI_GPS_MODE_BUTT
} HI_GPSMNG_GPS_MODE;
...
HI_S32 HI_GPSMNG_Init(HI_GPSMNG_GPS_MODE enGPSMode);
...
HI_BOOL HI_GPSMNG_GetState(HI_VOID);
