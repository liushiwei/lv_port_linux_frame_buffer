 ...
 * File Directory
 */
#define HI_DTCF_VIDEO_DIR        "Video"
#define HI_DTCF_PHOTO_DIR        "Photo"
#define HI_DTCF_VOICE_DIR        "Voice"
#define HI_DTCF_LOG_DIR          "Log"
#define HI_DTCF_GPS_DIR          "GPS"
#define HI_DTCF_MESSAGE_DIR      "Message"
#define HI_DTCF_EVENT_DIR        "Event"
#define HI_DTCF_EVENT_AI_DIR     "Event/AI"
#define HI_DTCF_HEALTH_DIR       "Health"
#define HI_DTCF_UPDATE_DIR       "Update"
...
typedef enum hiDTCF_FILE_TYPE_E
{
    ...
    HI_DTCF_FILE_TYPE_WAV,
    HI_DTCF_FILE_TYPE_TXT,
    HI_DTCF_FILE_TYPE_GPS,
...
/**
  *    @brief get index by file.
  *    @param[in]   pazFileName: file name.
  *    @param[in]    u32Length:  file length .
  *    @param[out]   u32Index: file index.
  *    @return       0 success, non-zero error code
  */
HI_S32 HI_DTCF_GetIndexByFile(HI_CHAR *pazFileName, HI_U32 u32Length, HI_U32 *u32Index);

/**
  *    @brief set filename prefix.
  *    @param[in]    pazFileNamePrefix:  filename prefix.
  *    @param[in]    enDir:  file dir type to add.
  *    @return       0 success, non-zero error code
  */
HI_S32 HI_DTCF_SetFileNamePrefix(const HI_CHAR *pazFileNamePrefix);
