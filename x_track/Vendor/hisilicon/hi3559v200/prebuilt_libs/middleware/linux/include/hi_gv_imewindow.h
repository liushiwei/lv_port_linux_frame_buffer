 ...
 * Description: Input method window
 * Author: NULL
 * Create: 2009-2-9
 */
...
typedef struct {
    ...
    HI_U8 candidateNum; /* Display candiate number */
...
\param[in]  pCreatInfo Create inforamtion.CNcomment:输入法窗口初始化信息
\param[out] phWidget Input method window handle.  CNcomment:创建的输入法窗口句柄指针
\retval ::HI_SUCCESS
...
\attention \n
N/A.CNcomment:无
\param[in]  hIMEWindow   Input method window handle. CNcomment:输入法窗口
\param[in]  hSwitchIMW  switch window CNcomment:控制显示输入法
\retval ::HI_SUCCESS
\retval ::HI_ERR_COMM_LOST
\retval ::HI_ERR_COMM_INVAL
\see \n
...
\param[in]  IMNum   Input method number.CNcomment: 绑定输入法数目
\retval ::HI_SUCCESS
\retval ::HI_ERR_COMM_LOST
\retval ::HI_ERR_COMM_INVAL
\see \n
...
\attention \n
N/A.CNcomment:无
\param[in]  hIMEWindow Input mesthod window handle.CNcomment:输入法窗口
\retval ::HI_TRUE  Show. CNcomment:显示
...
N/A.CNcomment:无
\param[in]  hIMEWindow   Input method window handle.  CNcomment:输入法窗口
\param[in]  softKB  Softkeyboad winddow handle. CNcomment:软键盘窗口
\param[in]  bShow  show/hide. CNcomment:显示或隐藏
\retval ::HI_SUCCESS
\retval ::HI_ERR_COMM_LOST
\retval ::HI_ERR_COMM_INVAL
\see \n
...
N/A.CNcomment:无
\param[in]  hIMEWindow  Input method window handle.  CNcomment:输入法窗口
\param[out]  pIME  The pointer of inpute method. CNcomment: 当前输入法指针
\retval ::HI_SUCCESS
\retval ::HI_ERR_COMM_LOST
\retval ::HI_ERR_COMM_INVAL
\see \n
...
\attention \n
N/A.CNcomment:无
\param[in]  IME  Input method.  CNcomment:重设的输入法
\param[in]  pKeyValue   The pointer of Key value.CNcomment:映射指针
