...
typedef struct hiFSTOOL_CHECK_CFG
{
    ...
    unsigned int parts;                                  /**< file system check number of gradation*/
...
typedef struct hiFSTOOL_FORMAT_CFG
{
    ...
    char diskLabel[HI_DISK_LABEL_LEN];                 /**< disk volume label name*/
    unsigned int parts;                                /**< file system format number of gradation*/
